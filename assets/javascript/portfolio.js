...
$(document).ready(() => {
  const links = [
    ...
    {
      name: 'Github',
      link: 'https://github.com/hanicsgo',
    },
    {
      name: 'Behance',
      link: 'https://www.behance.net/sogoodtobebad',
    },
    {
      name: 'Facebook',
      link: 'https://www.facebook.com/hanifancy/',
    },
    {
      name: 'Instagram',
      link: 'https://www.instagram.com/haitranxhani/',
    },
  ];
...
$.getJSON(ipgeolocation, (data) => {
  writeLine(['Authenticating...', "Granting access to <span style='font-size: 14px; color: #06d;'>[haitranportfolio.dev]</span>..."], 30, () => {
    ...
    writeLine([`Access granted! <span style='font-size: 14px; color: #0f0;'>[success]</span>`, `Welcome back, <i style='color: #0f0'>${ip}</i>! /// Location ${city}, ${country}.`], 30, 500, () => {
      ...
      writeLine([`<i style='color: #F62459'>haitranportfolio.dev ///</i>`], 120, 500, () => {
        timeouts.push(
          setTimeout(() => {
            if (app.skippedIntro) return;
